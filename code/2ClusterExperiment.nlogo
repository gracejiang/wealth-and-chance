...
878
100
OIDD 325 Case 1: 2-Cluster Experiment
24
0.0
1
...
@#$#@#$#@
<experiments>
  <experiment name="2-Cluster Experiment" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>blue-wealth-mean - pink-wealth-mean</metric>
    <metric>blue-pct-wealth</metric>
    <metric>pink-pct-wealth</metric>
    <metric>blue-to-pink-wealth-ratio</metric>
    <enumeratedValueSet variable="num-turtles">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="num-clusters">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="blue-cluster-density">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="blue-distance-to-manna">
      <value value="400"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="manna-diffusion-rate">
      <value value="0.025"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="init-manna-amount">
      <value value="180"/>
    </enumeratedValueSet>
    <steppedValueSet variable="pink-distance-to-manna" first="400" step="4" last="500"/>
    <enumeratedValueSet variable="init-manna">
      <value value="&quot;Single Hill&quot;"/>
    </enumeratedValueSet>
    <steppedValueSet variable="pink-cluster-density" first="1" step="2" last="9"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
