...
to go
  ...
  ask turtles [
    ...
    set wealth (wealth + (wealth * interest-rate * 0.01) - (cost-of-living / 10000)) ;
...
935
100
OIDD 325 Case 1: Wealth Growth Experiment
24
0.0
1
...
@#$#@#$#@
<experiments>
  <experiment name="Wealth-Growth-Experiment" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="interest-rate" first="0" step="0.4" last="10"/>
    <steppedValueSet variable="rich-init-wealth" first="0" step="2" last="50"/>
